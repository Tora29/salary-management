...
export const salarySlipCreateSchema = z
	...
	.refine((data) => new Date(data.paymentDate) >= new Date(data.targetPeriodEnd), {
...
export const sanitizeInput = (
	input: any,
	type: 'string' | 'number' | 'email' | 'html' = 'string'
): any => {
...
export const COMPRESSION_CONFIG: CompressionConfig = {
	...
	mimeTypes: ['application/json', 'text/plain', 'text/html', 'text/csv', 'application/xml']
};
