<script lang="ts">
	...
	import type { MonthlySalaryData } from '../model/types';

	interface Props {
		title: string;
		salaryData: MonthlySalaryData | null;
		loading?: boolean;
		error?: string | null;
	...
	<div class="p-6">
		...
		{:else if salaryData}
			<div class="mt-2">
				...
				{#if showComparison && salaryData.previousMonthComparison}
					{@const comparison = salaryData.previousMonthComparison}
				...
				{#if salaryData.totalIncome && salaryData.totalDeductions}
					<div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
						<div class="flex justify-between text-sm">
							<span class="text-gray-500 dark:text-gray-400">支給総額</span>
							<span class="font-medium text-gray-900 dark:text-white">
								{formatCurrency(salaryData.totalIncome)}
							</span>
						</div>
						<div class="flex justify-between text-sm">
							<span class="text-gray-500 dark:text-gray-400">控除総額</span>
							<span class="font-medium text-gray-900 dark:text-white">
