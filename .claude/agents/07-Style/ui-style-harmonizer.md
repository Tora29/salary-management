...
1. **シンプルなテーマシステム** (data-theme属性ベース):
...
2. **汎用クラスの定義**:
   ...
   .btn-secondary {
   	@apply px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400;
   }
   .btn-danger {
   ...
   /* フォーム要素 */
   .input-base {
   	@apply w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2;
   }
   .input-error {
